...
public class FloorView extends JPanel {
	...
	private class PassengerContainerView extends JComponent {
		...
		public PassengerContainerView(List<Passenger> list) {
			super();
			this.list = list;
		...
		public synchronized void update(List<Passenger> list) {
			this.list = list;
		}
	...
	private class ElevatorView extends PassengerContainerView {
		...
		public ElevatorView(List<Passenger> list) {
			super(list);
	...
	public FloorView(List<Passenger> dispathStory, List<Passenger> arrivalStory) {
		super();
	...
	public void update(List<Passenger> dispathStory,
			List<Passenger> arrivalStory, List<Passenger> elevatorStory) {
